...
func registerAuthRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("/api/v1/auth/signup/otp/request", handlers.SignupOtpRequestHandler)
	mux.HandleFunc("/api/v1/auth/signup/otp/verify", handlers.SignupOtpVerifyHandler)
